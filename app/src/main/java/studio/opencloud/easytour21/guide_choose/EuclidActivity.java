package studio.opencloud.easytour21.guide_choose;
...
import studio.opencloud.easytour21.internet.interfaces.user.UserSelectGuide_Interface;
...
public abstract class EuclidActivity extends Activity {
    ...
    *end
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //YYH
        btnSelect = findViewById(R.id.btn_guide_details_euclid_select);
        rbStars = findViewById(R.id.rb_guide_details_stars);
        tvPoint = findViewById(R.id.tv_guide_details_star_point);
        //YYH
        ...
        findViewById(R.id.toolbar_profile_back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                animateCloseProfileDetails();//点击后退按钮播放退出动作
            }
        });
    ...
    private View.OnClickListener MyListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_guide_details_euclid_select:
                    select();
                    break;
    ...
    private void select() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        // 步骤5:创建 网络请求接口 的实例
        UserSelectGuide_Interface request = retrofit.create(UserSelectGuide_Interface.class);

        //对 发送请求 进行封装(设置需要翻译的内容)
        collectInfo();

        Call<Register_Translation> call = request.selectGuide(orderID, guideNumber);
        ...
        call.enqueue(new Callback<Register_Translation>() {
            ...
            public void onResponse(Call<Register_Translation> call, Response<Register_Translation> response) {
                ...
                Toast.makeText(EuclidActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                System.out.println("********************************************************");
                }
            }
            ...
            public void onFailure(Call<Register_Translation> call, Throwable throwable) {
                ...
                Toast.makeText(EuclidActivity.this, "请求失败", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        ...
        rbStars.setRating((float)item.get(EuclidListAdapter.KEY_GUIDE_STAR_POINT));
        tvPoint.setText(String.valueOf(item.get(EuclidListAdapter.KEY_GUIDE_STAR_POINT)));
        orderID = (int)item.get(EuclidListAdapter.KEY_ORDER_ID);
        guideNumber = (String) item.get(EuclidListAdapter.KEY_GUIDE_NUMBER);
     ...
     *
     * @return - adapter with data. Check {@link studio.opencloud.easytour21.guide_choose.EuclidListAdapter}
     */
     ...
     *
     * @return - {@link studio.opencloud.easytour21.guide_choose.EuclidState}
     */
