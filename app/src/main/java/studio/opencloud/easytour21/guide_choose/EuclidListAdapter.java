...
public class EuclidListAdapter extends ArrayAdapter<Map<String, Object>> {
    ...
    public static final String KEY_GUIDE_STAR_POINT = "guide_star_point";
    public static final String KEY_ORDER_ID = "order_id";
    public static final String KEY_GUIDE_NUMBER = "guide_number";
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String imgUrl = (String) mData.get(position).get(KEY_AVATAR);
    ...
    static class ViewHolder {
        View mViewOverlay;
        ImageView mListItemAvatar;//导游头像
        TextView mListItemName;//导游姓名
        TextView mListItemDescription;//导游简介
    }
}
