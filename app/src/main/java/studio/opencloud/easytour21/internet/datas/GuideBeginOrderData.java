...
public class GuideBeginOrderData implements Parcelable{
    //导游可获取的订单信息
    private int orderID;
    ...
    public static final Parcelable.Creator<GuideBeginOrderData> CREATOR = new Parcelable.Creator<GuideBeginOrderData>() {

        @Override
        public GuideBeginOrderData createFromParcel(Parcel source) {
            // TODO Auto-generated method stub
            GuideBeginOrderData guideOrderData = new GuideBeginOrderData();
        ...
        @Override
        public GuideBeginOrderData[] newArray(int size) {
            // TODO Auto-generated method stub
            return new GuideBeginOrderData[size];
        }
    };
}
