...
public class SelfOrder {
    ...
    public SelfOrder(int picture, String place, String describle, String date, String days){
        this.mImage = picture;
        this.mPlace = place;
    ...
    public SelfOrder(int mImage, String mPlace, String mPlaceDescrible, String mDate, String mDays,
