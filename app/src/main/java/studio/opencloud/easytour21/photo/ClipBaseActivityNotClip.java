package studio.opencloud.easytour21.photo;
...
public abstract class ClipBaseActivityNotClip extends CheckPermissionsActivity
{
    ...
    public void requestRuntimePermission(String[] permissions, PermissionListener listener) {
        ...
        for (String permission : permissions) {
            if (ContextCompat.checkSelfPermission(ClipBaseActivityNotClip.this, permission) != PackageManager.PERMISSION_GRANTED) {
                permissionList.add(permission);
            }
        }
        if (!permissionList.isEmpty()) {
            ActivityCompat.requestPermissions(ClipBaseActivityNotClip.this, permissionList.toArray(new String[permissionList.size()]), 1);
        } else {
            mListener.onGranted();
        }
    }
...
//            imageUri = Uri.fromFile(new File(PHOTOSAVEPATH, photoname));
            ...
            imageUri = FileProvider.getUriForFile(ClipBaseActivityNotClip.this, "studio.opencloud.easytour21.fileprovider",cameraFile );
        }
