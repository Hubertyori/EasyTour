...
public abstract class EuclidActivity extends Activity {
    ...
    private com.example.xh.login.EuclidState mState = com.example.xh.login.EuclidState.Closed;
    ...
    private void initList() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                mState = com.example.xh.login.EuclidState.Opening;
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        ...
        Picasso.with(com.example.xh.login.EuclidActivity.this).load((Integer) item.get(EuclidListAdapter.KEY_AVATAR))
    ...
    private Animator getOpenProfileToolbarAnimator() {
        ...
        mOpenProfileToolbarAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                mState = com.example.xh.login.EuclidState.Opened;
            }
    ...
    private void animateCloseProfileDetails() {
        mState = com.example.xh.login.EuclidState.Closing;
        ...
        if (mCloseProfileAnimatorSet == null) {
            ...
            mCloseProfileAnimatorSet.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    mState = com.example.xh.login.EuclidState.Closed;
                }
    ...
    public void onBackPressed() {
        if (getState() == com.example.xh.login.EuclidState.Opened) {
            animateCloseProfileDetails();
        } else if (getState() == com.example.xh.login.EuclidState.Closed) {
            super.onBackPressed();
        }
    }
     ...
     *
     * @return - adapter with data. Check {@link com.example.xh.login.EuclidListAdapter}
     */
     ...
     *
     * @return - {@link com.example.xh.login.EuclidState}
     */
    public com.example.xh.login.EuclidState getState() {
        return mState;
    }
