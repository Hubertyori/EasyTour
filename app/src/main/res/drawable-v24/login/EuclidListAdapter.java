...
public class EuclidListAdapter extends ArrayAdapter<Map<String, Object>> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(getContext()).load((Integer) mData.get(position).get(KEY_AVATAR))
                .resize(com.example.xh.login.EuclidActivity.sScreenWidth, com.example.xh.login.EuclidActivity.sProfileImageHeight).centerCrop()
        ...
        viewHolder.mViewOverlay.setBackground(com.example.xh.login.EuclidActivity.sOverlayShape);
