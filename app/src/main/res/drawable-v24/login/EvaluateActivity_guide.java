...
public class EvaluateActivity_guide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finish_order_guide);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(com.example.xh.login.EvaluateActivity_guide.this,"你得到了"+rating+"颗星",Toast.LENGTH_SHORT).show();
            }
        });
    }
}
