...
public class activity_check_order_near extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_order_near_guide);
    ...
    {
        Intent intent =new Intent(com.example.xh.login.activity_check_order_near.this, com.example.xh.login.OrderActivity_guide.class);
        //启动
        startActivity(intent);
        this.finish();
    }
    public  void apply_guide()//申请成为导游
    {


    }

    public void guest_information(View view)
    {
        Intent intent =new Intent(com.example.xh.login.activity_check_order_near.this, com.example.xh.login.Guest_Information.class);
        //启动
        startActivity(intent);
